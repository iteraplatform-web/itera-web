...
> = {
  ...
  listing_updated: { icon: Home, tone: "bg-sky-50 text-sky-600" },
  showing_logged: { icon: ClipboardList, tone: "bg-amber-50 text-amber-600" },
  marketing_updated: { icon: Megaphone, tone: "bg-violet-50 text-violet-600" },
  ...
  media_updated: { icon: Camera, tone: "bg-sky-50 text-sky-600" },
  agreement_updated: { icon: FileText, tone: "bg-itera-50 text-itera-600" },
  automation: { icon: Zap, tone: "bg-violet-50 text-violet-600" },
  photo_added: { icon: Camera, tone: "bg-sky-50 text-sky-600" },
